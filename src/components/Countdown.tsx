...
const Countdown = () => {
  ...
  const TimeUnit = ({ value, label, showDivider = true }: { value: number; label: string; showDivider?: boolean }) => (
    <div className="countdown-item flex items-center gap-2 md:gap-6">
  ...
  return (
    <section 
      ref={containerRef}
      className="relative py-20 md:py-32 px-4 bg-[#0a0a0a]"
    >
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        {/* Forces single row on all screens using flex-nowrap or grid-cols-4 */}
