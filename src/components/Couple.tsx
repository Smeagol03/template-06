...
import Bg from "../assets/dekoratif/latar-2.webp";
...
const Couple = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(10, 10, 10, 0.85), rgba(10, 10, 10, 0.85)), url(${Bg})`,
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="font-serif text-3xl md:text-6xl text-white">
            Groom <span className="italic font-light text-white/60">&</span>{" "}
            Bride
          </h2>
        </motion.div>
